...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        count = 0
        n_place = self.place
        while n_place is not None and not n_place.is_hive:
            if n_place.bees and self.lower_bound <= count <= self.upper_bound:
                return random_bee(n_place.bees)
...
class QueenAnt(ThrowerAnt):
    ...
    def action(self, gamestate):
        ...
        # BEGIN Problem 12
        "*** YOUR CODE HERE ***"
        super().throw_at(super().nearest_bee())
